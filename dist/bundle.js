...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new _vue2.default(_main2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apps = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  HANDLE_DATA: function HANDLE_DATA(state, data) {
	    _fn2.default.handleData(state, data);
	  }
	};
...
/***/ function(module, exports) {
	...
	exports.default = {
	  handleData: function handleData(state, data) {
	    if (state[data.name] && typeof state[data.name][data.key] !== 'undefined') {
	      var appState = state[data.name];
	      switch (data.method) {
	        case 'add':
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  connect: function connect(store, name) {
	    _tcp2.default.createConnection(store, name);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  createConnection: function createConnection(store, name) {
	    var domain = _address2.default[name].domain;
	    var port = _address2.default[name].port;
	    ...
	    return {
	      send: function send(key) {
	        ...
	        if (key) {
	          client.write((0, _stringify2.default)({ key: key, value: value, method: method }));
	        }
	      },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blockState = __webpack_require__(31);

	var _blockState2 = _interopRequireDefault(_blockState);
	...
	module.exports = {
	  ...
	  methods: _vuex2.default.mapActions({
	    connect: 'connect'
	  }),
	  components: {
	    number: _number2.default,
	    blockState: _blockState2.default
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_options__.functional) {console.error("[vue-loader] number.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./number.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./number.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  watch: {
	    value: function value(val) {
	      ...
	      var t = parseInt(((this.target - this.current) * 16 / 250).toFixed(0));
	  ...
	  methods: {
	    run: function run() {
	      ...
	      this.loop = setInterval(function () {
	        if (_this.step >= 0 && _this.current + _this.step >= _this.target) {
	          _this.stop();
	          return;
	        }
	        if (_this.step < 0 && _this.current + _this.step <= _this.target) {
	        ...
	        _this.current = _this.current + _this.step;
	      }, 16);
	    },
	    stop: function stop() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('span', {}, ["\n  " + _s((current / Math.pow(10, this.float)).toFixed(this.float)) + "\n"])
	}},staticRenderFns: []}
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_options__.functional) {console.error("[vue-loader] blockState.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./blockState.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./blockState.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  methods: {
	    run: function run() {
	      ...
	      this.loop = setInterval(function () {
	        if (_this.upDirection) {
	          if (_this.value <= _this.step * (_this.current + 1) && _this.value > _this.step * _this.current) {
	            _this.stop();
	            _this.list.splice(_this.current, 1, ((_this.value - _this.step * _this.current) / _this.step).toFixed(2));
	          } else {
	            _this.list.splice(_this.current, 1, 1);
	          ...
	          if (_this.value <= _this.step * (_this.current + 1) && _this.value > _this.step * _this.current) {
	            ...
	            _this.list.splice(_this.current, 1, 0);
	            _this.changeCurrent(-1);
	          }
	        }
	      }, 16);
